...
"""Gutenberg format resolution (moved from `papers2zim.pg_archive_urls`
and `papers2zim.download`).
...
from papers2zim.core.ports import DownloadRequest, FormatResolverPort
