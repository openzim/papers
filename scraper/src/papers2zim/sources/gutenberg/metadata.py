"""Gutenberg metadata access (moved from `papers2zim.rdf`).
...
from papers2zim.core.ports import DownloadRequest, MetadataPort, WorkRef
from papers2zim.core.utils import normalize
