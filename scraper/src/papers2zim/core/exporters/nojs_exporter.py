"""No-JavaScript fallback HTML pages exporter (moved from `papers2zim.export`).
...
from papers2zim.core.language import language_name
...
def generate_noscript_pages(
    ...
    *,
    ...
    common_css = resources.files("papers2zim") / "templates" / "noscript" / "common.css"
