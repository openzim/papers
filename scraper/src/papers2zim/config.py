...
from papers2zim.core.utils import ALL_FORMATS, critical_error
from papers2zim.sources.registry import SOURCES, SourceProfile, get_source
...
def build_scrape_config(arguments: dict) -> ScrapeConfig:
    ...
    output_folder = Path(
        ...
        or os.getenv("PAPERS_OUTPUT", "./output")
    )
    cache_dir = (
